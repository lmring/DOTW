...
function weaponSearch() {
	...
	var typeResults = results.filter(checkWeaponType);
		for (var i = 0, len = typeResults.length; i < len; i++) {
			...
			content = "<div class='row'><div class='col-sm-8 col-sm-offset-2'><div class = 'panel panel-equipment'><div class = 'panel-heading panel-heading-equipment'>" + weapon.name + "</div><div class='panel-body'>" + '<p><b>Damage: </b>' + weapon.damage + '</p><p><b>Properties: </b>' + weapon.properties + '<p><b>Type: </b>' + weapon.type + "</p></div></div></div></div>";
			content += '<br/>';
